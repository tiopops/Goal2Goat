...
window.TRANSLATIONS = {
  ...
  'draft.generating':     {es:'GENERANDO EQUIPO...',  en:'GENERATING TEAM...'},
  'draft.generating_btn': {es:'Generando...',          en:'Generating...'},
  ...
  'ticket.accumulated':        {es:'Puntos acumulados en el boleto', en:'Points accumulated on card'},
  'ticket.next_in':            {es:'Próximo ticket en',             en:'Next ticket in'},
  'ticket.scratched':          {es:'Casillas rascadas',             en:'Scratched cells'},
  'ticket.next_risk':          {es:'Riesgo de la próxima casilla',  en:'Risk of next cell'},
  'ticket.serial':             {es:'Nº',                           en:'No.'},
  'ticket.edition_gold':       {es:'EDICIÓN ORO',                  en:'GOLD EDITION'},
  'ticket.prize_champion':     {es:'Premio por ganar el Mundial',   en:'Prize for winning the World Cup'},
  ...
  'ticket.error':              {es:'Error cargando tickets.',       en:'Error loading tickets.'},
  'ticket.firebase_error':     {es:'Firebase no disponible. Recarga la página.', en:'Firebase unavailable. Please reload.'},
  'ticket.result_win_auto':    {es:'¡TICKET PREMIADO!',            en:'TICKET WINNER!'},
  'ticket.result_win_cash':    {es:'¡TICKET PREMIADO!',            en:'TICKET WINNER!'},
  'ticket.result_lose':        {es:'TICKET ANULADO',               en:'TICKET CANCELLED'},
  'ticket.result_win_auto_msg':{es:'Rascaste todo el boleto. Premio máximo.',   en:'You scratched the full card. Maximum prize.'},
  'ticket.result_win_cash_msg':{es:'¡Buena jugada! Te has retirado a tiempo.',  en:'Good call! You cashed out at the right time.'},
  'ticket.result_lose_msg':    {es:'Has perdido los puntos acumulados en este boleto.', en:'You lost the points accumulated on this card.'},
  'ticket.golden_title':       {es:'TICKET GOAT',                  en:'GOAT TICKET'},
  'ticket.golden_win_msg':     {es:'Tus puntos de campeón han sido guardados.', en:'Your champion points have been saved.'},
  'ticket.golden_lose_msg':    {es:'La casilla mala te ha quitado los puntos. ¡Casi!', en:'The bad cell took your points away. So close!'},
  'ticket.golden_win':         {es:'¡TICKET PREMIADO!',            en:'TICKET WINNER!'},
  'ticket.golden_lose':        {es:'TICKET ANULADO',               en:'TICKET CANCELLED'},
  'ticket.cell_lose':          {es:'PIERDE',                       en:'LOSE'},
  'ticket.cell_goat':          {es:'+4 PTS',                      en:'+4 PTS'},
  'ticket.cell_coin':          {es:'+1 PT',                       en:'+1 PT'},
  'ticket.cell_goat_gold':     {es:'+3 PTS',                      en:'+3 PTS'},
  'ticket.slot_n':             {es:'Boleto {0}/{1}',               en:'Card {0}/{1}'},
