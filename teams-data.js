  ...
  const LM_RIVALS = [
    ...
    {id:'lm_4',  name:'Athletic Club',        attack:77, defense:81, pace:83, passing:72, technique:71, crestImg:ESCUDOS_DIR+'athletic.png',
      plantilla:[
        ...
        {n:27,name:'Álex Padilla',pos:'POR',attack:22,defense:76,pace:48,passing:60,technique:62}
      ]},
    {id:'lm_5',  name:'Villarreal CF',        attack:75, defense:78, pace:68, passing:83, technique:85, crestImg:ESCUDOS_DIR+'villarreal.png',
      plantilla:[
        ...
        {n:13,name:'Diego Conde',pos:'POR',attack:20,defense:74,pace:48,passing:58,technique:60},
        ...
        {n:25,name:'Tenas',pos:'POR',attack:22,defense:76,pace:46,passing:60,technique:62},
    ...
    {id:'lm_6',  name:'Real Betis',           attack:83, defense:62, pace:74, passing:81, technique:84, crestImg:ESCUDOS_DIR+'betis.png',
      plantilla:[
        ...
        {n:25,name:'Pau López',pos:'POR',attack:24,defense:78,pace:52,passing:64,technique:64},
        {n:30,name:'Germán García',pos:'POR',attack:20,defense:72,pace:46,passing:56,technique:56},
        ...
        {n:41,name:'Manu González',pos:'POR',attack:20,defense:70,pace:44,passing:54,technique:54},
    ...
    {id:'lm_7',  name:'Real Sociedad',        attack:73, defense:77, pace:67, passing:83, technique:80, crestImg:ESCUDOS_DIR+'realsociedad.png',
      plantilla:[
        ...
        {n:13,name:'Marrero',pos:'POR',attack:22,defense:74,pace:48,passing:60,technique:60},
    ...
    {id:'lm_8',  name:'Sevilla FC',           attack:71, defense:81, pace:76, passing:69, technique:69, crestImg:ESCUDOS_DIR+'sevilla.png',
      plantilla:[
        ...
        {n:13,name:'Nyland',pos:'POR',attack:20,defense:74,pace:44,passing:58,technique:58},
    ...
    {id:'lm_9',  name:'RC Celta',             attack:76, defense:57, pace:82, passing:71, technique:79, crestImg:ESCUDOS_DIR+'celta.png',
      plantilla:[
        ...
        {n:13,name:'Andrei Radu',pos:'POR',attack:20,defense:72,pace:46,passing:58,technique:58},
    ...
    {id:'lm_10', name:'Valencia CF',          attack:67, defense:75, pace:79, passing:65, technique:68, crestImg:ESCUDOS_DIR+'valencia.png',
      plantilla:[
        ...
        {n:13,name:'Cristian Rivero',pos:'POR',attack:20,defense:72,pace:46,passing:56,technique:56},
        {n:14,name:'José Gayà',pos:'LI',attack:62,defense:75,pace:80,passing:76,technique:76},
        ...
        {n:25,name:'Julen Agirrezabala',pos:'POR',attack:22,defense:74,pace:48,passing:60,technique:60}
      ]},
    ...
    {id:'lm_15', name:'Elche CF',             attack:55, defense:72, pace:59, passing:59, technique:60, crestImg:ESCUDOS_DIR+'elche.png',
      plantilla:[
        ...
        {n:13,name:'Iñaki Peña',pos:'POR',attack:22,defense:76,pace:48,passing:62,technique:62},
    ...
    {id:'lm_16', name:'Levante UD',           attack:68, defense:47, pace:63, passing:61, technique:65, crestImg:ESCUDOS_DIR+'levante.png',
      plantilla:[
        ...
        {n:13,name:'Mathew Ryan',pos:'POR',attack:22,defense:76,pace:48,passing:62,technique:60},
        ...
        {n:32,name:'Alejandro Primo',pos:'POR',attack:18,defense:70,pace:44,passing:56,technique:54},
    ...
    {id:'lm_18', name:'RCD Mallorca',          attack:61, defense:66, pace:70, passing:63, technique:64, crestImg:ESCUDOS_DIR+'mallorca.png',
      plantilla:[{n:1,name:'Leo Román',pos:'POR'},{n:2,name:'Pablo Maffeo'},{n:3,name:'Martin Valjent'},{n:4,name:'Antonio Raíllo'},{n:24,name:'Toni Lato'},{n:5,name:'Omar Mascarell'},{n:8,name:'Manu Morlanes'},{n:10,name:'Sergi Darder'},{n:6,name:'Antonio Sánchez'},{n:12,name:'Samú Costa'},{n:20,name:'Pablo Torre'},{n:7,name:'Vedat Muriqi'},{n:9,name:'Abdón Prats'},{n:11,name:'Takuma Asano'},{n:15,name:'Zito Luvumbo'},{n:18,name:'Mateo Joseph'},{n:19,name:'Javi Llabrés'},{n:30,name:'Justin-Noel Kalumba'},{n:39,name:'Jandro García'},{n:41,name:'Jan Salas'}]},
    {id:'lm_19', name:'Real Oviedo',           attack:56, defense:60, pace:62, passing:58, technique:57, crestImg:ESCUDOS_DIR+'oviedo.png',
      plantilla:[{n:1,name:'Alberto Reina',pos:'POR'},{n:2,name:'Dendoncker'},{n:3,name:'Rahim Alhassane'},{n:4,name:'David Costas'},{n:5,name:'César de la Hoz'},{n:6,name:'Bretones'},{n:14,name:'Ovie Ejaria'},{n:10,name:'Haissem Hassan'},{n:28,name:'Lamine Gueye'},{n:7,name:'Ilyas Chaira'},{n:19,name:'Alex Fores'},{n:9,name:'Federico Viñas'},{n:23,name:'Salomón Rondón'},{n:18,name:'Josip Brekalo'},{n:17,name:'Thiago Borbas'},{n:15,name:'Thiago Fernández'},{n:8,name:'Rahim Sulemana'},{n:20,name:'Colombatto'},{n:22,name:'Nacho Vidal'},{n:16,name:'Ilyas Chouaref'}]},
    {id:'lm_20', name:'Girona FC',            attack:64, defense:63, pace:69, passing:70, technique:69, crestImg:ESCUDOS_DIR+'girona.png',
      plantilla:[
        {n:13,name:'Paulo Gazzaniga',pos:'POR',attack:20,defense:70,pace:52,passing:58,technique:56},
        {n:2,name:'Hugo Rincón',attack:52,defense:70,pace:72,passing:64,technique:62},
        {n:24,name:'Álex Moreno',attack:56,defense:68,pace:74,passing:66,technique:66},
        {n:17,name:'Daley Blind',attack:44,defense:76,pace:56,passing:76,technique:74},
        {n:12,name:'Vitor Reis',attack:38,defense:76,pace:66,passing:66,technique:62},
        {n:3,name:'Arnau Martínez',attack:48,defense:72,pace:76,passing:66,technique:64},
        {n:21,name:'Ricard Artero',attack:46,defense:70,pace:68,passing:62,technique:60},
        {n:5,name:'Ricardo Puig',attack:52,defense:66,pace:66,passing:74,technique:70},
        {n:14,name:'Iván Martín',attack:66,defense:56,pace:70,passing:74,technique:76},
        {n:8,name:'Óscar Sielva',attack:60,defense:58,passing:74,pace:60,technique:72},
        {n:6,name:'Axel Witsel',attack:52,defense:68,pace:56,passing:72,technique:70},
        {n:20,name:'Bryan Gil',attack:70,defense:36,pace:80,passing:70,technique:78},
        {n:11,name:'Viktor Tsygankov',attack:74,defense:38,pace:76,passing:68,technique:76},
        {n:7,name:'Yaser Asprilla',attack:68,defense:40,pace:74,passing:66,technique:72},
        {n:9,name:'Cristhian Stuani',attack:76,defense:34,pace:60,passing:56,technique:68},
        {n:19,name:'Bojan Miovski',attack:74,defense:32,pace:70,passing:56,technique:66},
        {n:23,name:'Jhon Solís',attack:70,defense:36,pace:78,passing:60,technique:68},
        {n:16,name:'Donny van de Beek',attack:62,defense:52,pace:64,passing:72,technique:74},
        {n:4,name:'Ureña',attack:44,defense:68,pace:68,passing:60,technique:58},
        {n:22,name:'Juan Carlos Martín',attack:36,defense:70,pace:62,passing:64,technique:60}
      ]},
  ];
