...
function quickBuild(){
  ...
  // Scroll to the card area so the spin animation is visible
  scrollTo("playerCardDesktop");
...
function initFirebaseAuth(){
  ...
  window.submitRegister=async function(){
    ...
    }catch(err){setErr("regGlobalErr",fbErr(err.code));setBtnLoading("regSubmitBtn",false);}
  };
